...
We used a modified version of the __alternating descent conditional gradient (ADCG)__ algorithm to obtain atom locations. At each iteration, the algorithm 1) __adds a new atom__ on a coarse grid and 2) __locally moves__ all atoms. An animated reconstruction run is shown on the right.
